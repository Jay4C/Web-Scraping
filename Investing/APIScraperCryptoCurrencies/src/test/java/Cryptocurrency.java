...
public class Cryptocurrency {
    ...
    void setNombreDeDevise(String nombreDeDevise) {
        this.nombreDeDevise = nombreDeDevise;
    }
    ...
    void setCapitalisationTotaleDuMarche(String capitalisationTotaleDuMarche) {
        this.capitalisationTotaleDuMarche = capitalisationTotaleDuMarche;
    }
    ...
    void setVolumeTotal24H(String volumeTotal24H) {
        this.volumeTotal24H = volumeTotal24H;
    }
    ...
    void setSymbole(String symbole) {
        this.symbole = symbole;
    }
    ...
    void setCoursUSD(String coursUSD) {
        this.coursUSD = coursUSD;
    }
    ...
    void setCapitalisationBoursiere(String capitalisationBoursiere) {
        this.capitalisationBoursiere = capitalisationBoursiere;
    }
    ...
    void setVolumeTotal(String volumeTotal) {
        this.volumeTotal = volumeTotal;
    }
    ...
    void setVariation24H(String variation24H) {
        this.variation24H = variation24H;
    }
    ...
    void setVariation7Jours(String variation7Jours) {
        this.variation7Jours = variation7Jours;
    }
}
