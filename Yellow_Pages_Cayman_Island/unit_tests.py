...
class UnitTestsDataMinerYellowPagesCaymanIslands(unittest.TestCase):
    ...
    def test_extract_each_email_from_one_page_of_results_for_one_activity_and_one_capital(self):
        ...
        url = "https://www.findyello.com/cayman-islands/?search=hotel&pageno=1"
    ...
    def test_extract_each_email_from_all_pages_of_results_for_all_activities_and_all_capitals(self):
        ...
        capitales_du_monde = [
            {'id': '941', 'nom': 'cayman-islands', 'pays': 'cayman-islands'},
        ]
