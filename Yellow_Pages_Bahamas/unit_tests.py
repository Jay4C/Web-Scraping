...
class UnitTestsDataMinerYellowPagesBahamas(unittest.TestCase):
    def test_extract_email_from_one_result(self):
        ...
        url = "https://www.findyello.com/abaco/abaco-inn/profile/"
    ...
    def test_extract_each_email_from_one_page_of_results_for_one_activity_and_one_capital(self):
        ...
        url = "https://www.findyello.com/abaco/?search=hotel&pageno=1"
    ...
    def test_extract_each_email_from_all_pages_of_results_for_all_activities_and_all_capitals(self):
        ...
        activites = [
            ...
            {'id': '2', 'url': 'real%20estate'},  # Real estate
        ...
        capitales_du_monde = [
            {'id': '930', 'nom': 'abaco', 'pays': 'bahamas'},
            {'id': '931', 'nom': 'family-islands', 'pays': 'bahamas'},
            {'id': '932', 'nom': 'grand-bahama', 'pays': 'bahamas'},
            {'id': '933', 'nom': 'new-providence', 'pays': 'bahamas'},
        ]
