...
class UnitTestsDataMinerYellowPagesGrenada(unittest.TestCase):
    def test_extract_email_from_one_result(self):
        ...
        url = "https://www.findyello.com/grenada/maca-bana-villas-luxury-boutique-resort/profile/"
    ...
    def test_extract_each_email_from_one_page_of_results_for_one_activity_and_one_capital(self):
        ...
        url = "https://www.findyello.com/grenada/?search=hotel&pageno=1"
    ...
    def test_extract_each_email_from_all_pages_of_results_for_all_activities_and_all_capitals(self):
        ...
        capitales_du_monde = [
            {'id': '943', 'nom': 'grenada', 'pays': 'grenada'},
        ]
