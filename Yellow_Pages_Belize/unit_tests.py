...
class UnitTestsDataMinerYellowPagesBelize(unittest.TestCase):
    def test_extract_email_from_one_result(self):
        ...
        url = "https://www.findyello.com/belize/paradise-villas-nellies-property-management/profile/40-pescador-drive/"
    ...
    def test_extract_each_email_from_one_page_of_results_for_one_activity_and_one_capital(self):
        ...
        url = "https://www.findyello.com/belize/?search=hotel&pageno=1"
